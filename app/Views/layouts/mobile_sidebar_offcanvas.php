    ...
    <div class="offcanvas-body d-flex flex-column">
        ...
        <div class="mt-auto pt-3 border-top">
            ...
            <div class="d-grid gap-2">
                <a class="btn btn-outline-secondary" href="<?= BASE_URL ?>/index.php?url=settings/index"><?= htmlspecialchars(t('nav.settings')) ?></a>
                <a class="btn btn-outline-danger" href="<?= BASE_URL ?>/index.php?url=auth/logout"><?= htmlspecialchars(t('nav.logout')) ?></a>
            </div>
        </div>
    </div>
</div>
